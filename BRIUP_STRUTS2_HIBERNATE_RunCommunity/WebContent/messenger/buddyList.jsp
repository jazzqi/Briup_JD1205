...
<script type="text/javascript">
		...
		function delBuddy(){
			...
			document.forms.buddyListForm.action="<%=basePath%>
	messenger/deleteBuddy.action";
		document.forms.buddyListForm.submit();
	}
</script>
</head>
		...
		<div id="main">
			...
			<div id="tabs1">
				<ul>
					...
					<li><a href="showFriendAction.action" title="好友名单"><span><b>好友名单</b></span></a></li>
							...
							<tr>
								<td colspan="2" width="100%">
									<table width="100%">
										...
										<tbody>
											<s:iterator value="friend">
												<tr>
													<th width="10%" align="center"><input type="checkbox"
														name="nickName" value="briup2" /></th>
													<td width="20%" align="center"><s:property value="nickname"/></td>
													<td width="20%" align="center">gender</td>
													<td width="20%" align="center"><s:property value="age"/></td>
													<td width="20%" align="center"><s:property value="provincecity"/></td>
													<td width="10%" align="center"><img
														src="../images/button_delete.gif" alt="移动到黑名单"
														onclick="window.location='\/RunCommunity\/messenger\/addBlackAction.action\?member_nickname=<s:property value='nickname'/>'"
