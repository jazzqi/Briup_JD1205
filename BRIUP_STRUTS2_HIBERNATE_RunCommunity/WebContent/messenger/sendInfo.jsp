...
<div id="main">
  ...
  <div id="header">
   ...
   <div id="tabs1">
  <ul>
    <li><a href="sendMessageAction.action" title="写纸条"><span><b>写纸条</b></span></a></li>
  ...
  <div id="content" align="center"> 
     <div id="center"><br/><br/>
		<table width="600">
			...
			<tr>
				<td width="100%">
					<form name="sendInfoForm" action="/RunCommunity/messenger/sendMessageAction.action" method="post" onsubmit="return sendInfo(this);">
						<table width="100%">
						<tbody>
						<tr>
							<th width="30%" class="line1" scope="col">收信人：</th>
							<td>
								<input type="text" name="message.receiver" style="width: 250;height: 25" value="${param.receiverName } "/>
							</td>
						</tr>
						<tr>
							<th>主题：</th>
							<td>
								<input type="text" name="message.title" style="width: 350;height: 25" />
							</td>
						</tr>
						<tr>
							<th>消息内容：</th>
							<td>
								<textarea name="message.content" rows="8" cols="55"></textarea>
							</td>
						</tr>
						</tbody>
						<tfoot>
