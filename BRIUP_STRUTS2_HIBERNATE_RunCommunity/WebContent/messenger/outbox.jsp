			...
			<table width="600" align="center" cellpadding="0" cellspacing="0">
				<thead>
					<tr>
						...
						<td><span onclick="javascript:delMessage();">
							<img src="../images/delete.gif" height="14"/>&nbsp;删除</span>						</td>
					</tr>
				</thead>
				...
				<tr>
					...
					<td width="100%" colspan="2">
						<table width="100%">
							...
							<tbody>
								<s:iterator value="outbox" id="messageInfo">
									<tr>
										<td width="10%">
											<input type="checkbox" name="ID" value="<s:property value='id' />" />
										</td>
										<td width="20%">
											<a href="viewMessageAction.action?id=<s:property value='id' />"><s:property value="title"/></a>
										</td>
										<td width="20%"><s:property value="receiver"></s:property></td>
										<td width="30%">
							...
							<tfoot>
							<tr>
								<td align="right" width="30%" colspan="4">
