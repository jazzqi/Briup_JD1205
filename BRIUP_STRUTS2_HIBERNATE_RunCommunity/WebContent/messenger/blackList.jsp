		...
		<div id="main">
			...
			<div id="tabs1">
				<ul>
					...
					<li><a href="showBlackAction.action" title="黑名单"><span><b>黑名单</b></span></a></li>
				</ul>
			</div>
			<br /> <br />
										...
										<tbody>
											<s:iterator value="black">
												<tr>
													...
													<td width="20%" align="center"><s:property
															value="provincecity" /></td>
													<td width="10%" align="center"><img
														src="../images/button_delete.gif" alt="移动到好友名单"
														onclick="window.location='\/RunCommunity\/messenger\/removeBlackAction.action\?member_nickname=<s:property value='nickname'/>'"
							...
							<li>
								<div>
									<img src="../images/c.gif" /> <a
										href="showFriendAction.action">我的好友</a>
									<p>好友管理及黑名单</p>
								</div>
							</li>
							<li>
