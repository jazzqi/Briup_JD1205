						...
						<table width="100%">
							...
							<tr>
								...
								<td width="10%" align="center">
									<img src="../images/button_delete.gif" alt="移动到黑名单" onclick="window.location='../pages/messenger/moveToBlackList.do?blackName=briup2'" style="cursor:hand"/>
								</td>
							</tr>
							...
							<tr>
								...
								<td width="10%" align="center">
									<img src="../images/button_delete.gif" alt="移动到黑名单" onclick="window.location='../pages/messenger/moveToBlackList.do?blackName=briup4'" style="cursor:hand"/>
								</td>
							</tr>
							<tr>
								<td width="20%" align="center">
								...
								<td width="20%" align="center">其它</td>
								<td width="10%" align="center">
									<img src="../images/button_delete.gif" alt="移动到黑名单" onclick="window.location='../pages/messenger/moveToBlackList.do?blackName=briup5'" style="cursor:hand"/>
								</td>
							</tr>
							...
							<tr>
								...
								<td width="20%" align="center">内蒙古</td>
								<td width="10%" align="center">
									<img src="../images/button_delete.gif" alt="移动到黑名单" onclick="window.location='../pages/messenger/moveToBlackList.do?blackName=briup6'" style="cursor:hand"/>
								</td>
							</tr>
							</tbody>						
