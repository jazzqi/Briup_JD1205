...
<div id="main">
  ...
  <div id="header">
    ...
    <div id="mainnav">
      ...
      <span>
							<form action="member/loginAction.action" method="post" id="login">
								<table width="100%">
									<tr>
										<td align="right">
											用户名：
											<input type="text" name="member.nickname" style="width: 80px" id="userName"/>
										</td>
										<td>
											密码：
											<input type="password" name="member.password" id="passwd"
										...
										<td>
											<img src="/RunCommunity/run/authImg" height:20px; width:60px"/>
										</td>
										<td>
										...
										<td>
											<a href="#" onclick="document.getElementById('login').submit()"
												...
												<img src="images/login.gif"
													name="login" border="0" id="login" /> </a>
										</td>
										<td>
											<a href="register.jsp"
												onmouseout="MM_swapImgRestore()"
