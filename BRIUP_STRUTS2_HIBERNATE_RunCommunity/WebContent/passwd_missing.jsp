...
<div id="main">
  ...
  <div id="content" align="center">
     ...
     <div id="center">
      ...
      <FORM onSubmit="return checkGetPasswdForm(this);" action="member/getNewPasswordAction.action"
      method="get">
      <TABLE width="100%" align=center border=0>
        ...
        <TR>
          ...
          <TD align=left width="60%"><INPUT class=input1 name="userName" id="userName"/> </TD></TR>
        <TR>
          <TD align=right width="40%">密码提示问题：</TD>
          <TD align=left width="60%"><INPUT class=input1 name="passwdQuestion" id="passwdQuestion" />          </TD></TR>
        <TR>
          <TD align=right width="40%">密码提示答案：</TD>
          <TD align=left width="60%"><INPUT class=input1 name="passwdAnswer" id="passwdAnswer"/>        </TD></TR>
        <TR>
          <TD colSpan=2>
