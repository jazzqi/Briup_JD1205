     ...
     <div id="center">
       ...
       <div id="ltd">
	     ...
	     <TABLE cellSpacing=0 cellPadding=0 border=0>
	  			<TR>
    				<TD width="100%">
     					<FORM onSubmit="return validateRegisterForm(this);" action="member/registerAction.action" method="post">
     						<TABLE width="100%">
        						<thead>
        						<TR>
         							<TH colSpan=3>
								...
								<TBODY>
       							<TR>
         							<TH width="25%">
          							...
          							<TD width="30%"><INPUT maxLength=14 name="member.nickname" id="nickName" style="width:200px"></TD>
         							<TH width="45%"><FONT color=#ff0000>昵称可使用长度为0-16的任何字符</FONT></TH>
								</TR>
								<TR>
									<TH>
									<DIV align="right"><FONT color=#ff0000>*</FONT> 密码： </DIV></TH>
								 	<TD><INPUT type=password maxLength=14 style="width:200px" name="member.password" id="passwd"></TD>
