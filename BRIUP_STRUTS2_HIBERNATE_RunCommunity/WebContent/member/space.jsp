						...
						<table width="100%">
							...
							<tr>
								<td rowspan="5" width="30%" class="line4">
									<img src='/RunCommunity/icon/<s:property value="icon"/>' alt=Face width="84" height="84" ></td>
							...
							<tr>
								...
								<td>
									<s:property value="point"></s:property>
								</td>
							</tr>
							<tr>
								<th class="line1">
								...
								<td>
									<s:property value="graderecord.gradename"></s:property>
								</td>
							</tr>
							<tr>
								<th class="line1">
							...
							<tr>
								...
								<td colspan="2" height="90">
									<span >&nbsp;&nbsp;&nbsp;
										<s:property value="runtime"/>， <s:property value="runhabit" />在<s:property value="runplace"/>上跑步，最喜欢体育明星是<s:property value="runstar"/>。
										愿意成为我的跑友者请与我(<s:property value="cellphone"/>)联系。
											本人对跑步的主张是：<s:property value="opinion"/>
									</span>
								</td>
							</tr>
							</tbody>
							...
							<tr>
								<td colspan="3">
									<input type="button" value="修改"
										onclick="location.href='createSpace.jsp';" style="width: 60;height: 25" />
