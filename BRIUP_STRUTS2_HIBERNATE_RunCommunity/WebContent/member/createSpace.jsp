				...
				<td width="100%">
					<table width="100%" border="0" style="margin: 5px 0;"
		 			...
		 			<tr>
		  			...
		  			<form action="createSpaceAction.action" method="post"	enctype="multipart/form-data">
					...
					<tr>
						...
						<TD width="50%" align="left">
							<INPUT class=INPUT1 type=text maxLength=14 name=space.opinion
					...
					<TR>
						...
						<TD width="50%" align="left">
									...
									<input name="space.runtime" class=radio1 type="radio" value="清晨" />清晨
									<input type="radio" name="space.runtime" class=radio1 value="午后" />午后
									<input type="radio" name="space.runtime" class=radio1	value="黄昏" checked="checked"/>黄昏						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">
							<FONT color=#ff9933>*</FONT> 喜欢独自跑还是结伴跑？						</TD>
						<TD width="50%" align="left">
							<input type="radio" name="space.runhabit" class=radio1 value="独自" />独自
							<input type="radio" name="space.runhabit" class=radio1 value="结伴" checked="checked"/>结伴
						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">
						...
						<TD align="left">
							<INPUT class=INPUT1 type=text maxLength=20 name=space.runstar	 style="width:200;height:25" />						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">
							<FONT color=#ff9933>*</FONT> 正在使用的手机：						</TD>
						<TD width="50%" align="left">
							<INPUT class=INPUT1 type=text maxLength=14 name=space.cellphone 
																style="width:200;height:25" />						</TD>
					</TR>
					<TR>
						<TD width="50%" align="right">
						...
						<TD width="50%" align="left">
							<INPUT class="INPUT1" type="text" maxLength="14" name="space.runplace"
					...
					<TR>
						...
						<TD align="left">
							<input type="file" name="image" style="width:200;height:25" />						</TD>
					</TR>									
    				<tr>
						<td colSpan="2">
							<div align="center">
        ...
        <div id="hots">
          ...
          <li>
           <div>
            ...
            <a href="../messenger/showInboxAction.action">我的信箱</a>
            <p>写信息、收件箱、发件箱</p>
           </div>
          </li>
          <li>
           <div>
            ...
            <a href="../messenger/showFriendAction.action">我的好友</a>
            <p>好友管理及黑名单</p>
           </div>
          </li>
          <li>
