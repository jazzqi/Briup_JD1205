  			...
  			<tr>
				<td width="100%">
					...
					<tr>
						...
						<td width="30%" >
							<input type="text" maxLength="14" style="width:200px" id="member.nickname" disabled />
						</td>
						<th width="45%" >
					...
					<tr>
						...
						<td>
							<input type="password" maxLength="14" style="width:200px" id="member.oldPasswd" />
						</td>
						<th>&nbsp;
					...
					<tr>
						...
						<td>
							<input type="password" maxLength="14" style="width:200px" id="newPasswd" />
						</td>
						<th>
					...
					<tr>
						...
						<td>
							<input type="password" maxLength="14" style="width:200px"	id="newPasswdre" />
						</td>
						<th>
					...
					<tr>
						...
						<td>
							<input type="text" maxLength="30" style="width:200px" id="email" />
						</td>
						<th>
					...
					<tr>
						...
						<th>
							<input style="width:200px" type="text" id="passwdQuestion" />
						</th>
						<th>
					...
					<tr>
						...
						<td>
							<input  type="text" style="width:200px" id="passwdAnswer" />
						</td>
						<th>
